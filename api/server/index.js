...
const jwtSecret='frcbfereurcwlurwcli4848';
...
app.post('/places',(req,res)=>{
    ...
    const placeDoc = await Place.create({
        owner:userData.id,title,address,photos:addedPhotos,description,price,perks,extraInfo,checkIn,checkOut,maxGuests
    });
    res.json(placeDoc);
  })
})
